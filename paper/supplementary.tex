...
\section*{S1 Model-Complexity Ablation}
...
\begin{table}[!h]
\centering
\caption{Exploratory data analysis summary for the seven audited datasets. All releases contain zero missing values. The datasets that fail the audit (MM-TBA, Entrance Exam, Higher Ed, UCI Student) each fail at least one dimension, yet none show distinctive EDA red flags---such as extreme imbalance or redundant features---that would pre-emptively disqualify them; the fragility is only revealed through the four-dimension audit.}
...
\midrule
OULAD & Linear & 0.284 & 0.270 & 0.014 & 0.024 \\
 & Ridge & 0.284 & 0.270 & 0.014 & 0.024 \\
 & RF & 0.909 & 0.374 & 0.535 & 0.026 \\
 & GBT & 0.432 & 0.386 & 0.045 & 0.025 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[!h]
\centering
\caption{Across-group variation in group-holdout $R^2$. The SD quantifies how consistent the group-holdout performance is across held-out groups. For UCI Student (2 schools), the linear-model SD of 0.109 with a narrow range ($-0.206$ to $0.012$) confirms uniform collapse rather than group-specific failure. For OULAD (22 cohorts), the across-cohort SD of 0.162 and full range ($0.041$ to $0.654$) reflect positive---though variable---cross-group generalization.}
...
OULAD & f3 & 0.159 & 0.003 & 0.00 \\
 ...
 & f9 & $-0.053$ & 0.002 & 0.00 \\
 & f5 & 0.048 & 0.003 & 0.00 \\
 & f10 & 0.046 & 0.003 & 0.00 \\
 & f31 & $-0.042$ & 0.005 & 0.00 \\
 & f1 & $-0.040$ & 0.003 & 0.00 \\
 & f0 & $-0.034$ & 0.003 & 0.00 \\
 & f33 & $-0.034$ & 0.006 & 0.00 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[!h]
\centering
\caption{Top-10 Random Forest feature importance stability across 100 repeated 80/20 splits. The coefficient of variation (CV = SD / mean) quantifies relative uncertainty. On OULAD, all top-10 CVs are below 0.12, indicating stable importance rankings. On UCI Student, CVs range from 0.08 to 0.20; on Higher Ed, from 0.18 to 0.41, reflecting greater split sensitivity in smaller datasets.}
...
\midrule
OULAD & f3 & 0.271 & 0.009 & 0.033 \\
 & f2 & 0.264 & 0.010 & 0.038 \\
 & f9 & 0.047 & 0.003 & 0.069 \\
 & f1 & 0.037 & 0.001 & 0.040 \\
 & f6 & 0.025 & 0.001 & 0.058 \\
 & f5 & 0.023 & 0.002 & 0.080 \\
 & f0 & 0.018 & 0.001 & 0.068 \\
 & f10 & 0.014 & 0.002 & 0.118 \\
 & f28 & 0.014 & 0.001 & 0.073 \\
 & f26 & 0.013 & 0.001 & 0.063 \\
\bottomrule
\end{tabular}
\end{table}
...
OULAD & f0 & num\_of\_prev\_attempts \\
 ...
 & f2 & score \\
 & f3 & sum\_click \\
 & f5 & code\_module\_BBB \\
 & f6 & code\_module\_CCC \\
 & f9 & code\_module\_FFF \\
 & f10 & code\_module\_GGG \\
 & f26 & highest\_education\_A Level or Equivalent \\
 & f28 & highest\_education\_Lower Than A Level \\
 & f31 & imd\_band\_0--10\% \\
 & f33 & imd\_band\_20--30\% \\
\bottomrule
\end{tabular}
\end{table}

\clearpage
\section*{S8 Cross-Model Attribution Agreement}

\begin{table}[!h]
\centering
\caption{Cross-model Spearman rank correlation between linear-model absolute standardized coefficients and Random Forest impurity-based importances across 100 repeated 80/20 splits. $\rho_{\mathrm{all}}$ uses all features; $\rho_{\mathrm{top10}}$ uses the top-10 features by linear absolute coefficient in each split. On OULAD, cross-model agreement is high and stable across splits ($\rho_{\mathrm{top10}} = 0.777$, SD 0.081). On UCI Student and Higher Ed, agreement is weaker and more variable, consistent with their lower-readiness profiles.}
\label{tab:cross_model_spearman}
\small
\begin{tabular}{l r r r r r}
\toprule
Dataset & $p$ & \multicolumn{2}{c}{$\rho_{\mathrm{all}}$} & \multicolumn{2}{c}{$\rho_{\mathrm{top10}}$} \\
\cmidrule(lr){3-4} \cmidrule(lr){5-6}
 & & Mean & SD & Mean & SD \\
\midrule
UCI Student & 54 & 0.496 & 0.093 & 0.516 & 0.242 \\
Higher Ed & 30 & 0.285 & 0.126 & 0.498 & 0.245 \\
OULAD & 46 & 0.617 & 0.040 & 0.777 & 0.081 \\
\bottomrule
\end{tabular}
\end{table}

\clearpage
\section*{S9 Supplementary Figures}
